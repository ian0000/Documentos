...
public class ParametrosController {
 @Autowired
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> createParametros(@RequestBody ParametrosCrear objeto) {
    ...
    @PostMapping("/update")
    public ResponseEntity<Object> updateParametros(@RequestBody ParametrosCrear objeto) {
